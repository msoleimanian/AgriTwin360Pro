...
if uploaded_file is not None:
    ...
    img_col1, img_col2 = st.columns([1, 1])  # Adjust column widths for images
    ...
    with img_col2:
        st.image(processed_image, caption="Processed Image", width=350)

    # Create a three-column layout for the right side with Summary and Dropdown
    summary_col, dropdown_col = st.columns([2, 1])  # Adjust columns width for text and dropdown
